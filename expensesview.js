...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function openExpenseModal(type, householdMemberId, expense = null) {
        ...
        const expenseFrequencyInput = document.getElementById(`${type}ExpenseFrequency`); // Add frequency input
        ...
        if (client) {
            ...
            saveButton.onclick = function () {
                ...
                if (!expenseData.type || isNaN(expenseData.value) || !expenseData.frequency) {
